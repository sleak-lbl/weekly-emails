# NERSC Weekly Email, Week of December 21, 2020 <a name="top"></a> #
...
- [(NEW) Happy Holidays from NERSC](#holwishes)
- [NERSC Operations Continue, with Minimal Shelter-in-Place Impacts](#curtailment)

## [This Week's Events and Deadlines](#section2) ##

- [(NEW) Final Weekly Email of the Year](#lastemail)
- [(NEW) Consulting & Account Support Holidays Thursday through January 1](#holidays)
- [Let NERSC Know How We're Doing via the NERSC User Survey!](#usersurvey)

## [Updates at NERSC ](#section3) ##

- [Plan for the New Allocation Year, Beginning January 20, 2021](#newayplan)
- [(NEW) Resolution of cscratch1 Issues](#cscratch1)
- [Large Memory Nodes on Cori and Spin Available to Users](#largemem)
- [Cori Default Python Modules Changing Today](#pythonmodules)
...
### (NEW) Happy Holidays from NERSC <a name="holwishes"/></a> 
...
### (NEW) Final Weekly Email of the Year <a name="lastemail"/></a> 

This is the final NERSC weekly email for 2020. Weekly emails will resume on
Monday, January 4, 2021.


### (NEW) Consulting & Account Support Holidays Thursday through January 1 <a name="holidays"/></a> 
...
### Let NERSC Know How We're Doing via the NERSC User Survey! <a name="usersurvey"/></a> 
...
### (NEW) Resolution of cscratch1 Issues <a name="cscratch1"/></a> 
...
### Cori Default Python Modules Changing Today <a name="pythonmodules"/></a> 
