...
- [CUDA Multi-Process Service Training Tomorrow!](#cutrain)
- [(NEW) Join Us for the NUG Meeting, this Thursday 19 August, 11am PT](#webinar)
...
- [(NEW) Cori Burst Buffer (DataWarp) Unavailable](#burstbuffer)
...
- [(NEW) Better Scientific Software 2022 Fellowship Program Applications Now Open!](#bssw)
...
- [(NEW) Training on E4S at DOE Facilities with Deep Dive at NERSC, October 4](#e4sdd)
- [Four-Day CMake Training, August 23-26](#cmake)
- [Using Variorum for Portable Power Management Code, August 20 & 27](#variorum)
...
- [Intro to Kernel Performance Analysis with NVIDIA Nsight Compute, August 26](#nsighttrain)
...
### CUDA Multi-Process Service Training Tomorrow! <a name="cutrain"/></a> 
...
### (NEW) Join Us for the NUG Meeting, this Thursday 19 August, 11am PT <a name="webinar"/></a> 
...
### (NEW) Cori Burst Buffer (DataWarp) Unavailable <a name="burstbuffer"/></a> 
...
### (NEW) Better Scientific Software 2022 Fellowship Program Applications Now Open! <a name="bssw"/></a> 
...
### (NEW) Training on E4S at DOE Facilities with Deep Dive at NERSC, October 4 <a name="e4sdd"/></a> 
...
### Using Variorum for Portable Power Management Code, August 20 & 27 <a name="variorum"/></a> 
...
### Intro to Kernel Performance Analysis with NVIDIA Nsight Compute, August 26 <a name="nsighttrain"/></a> 
