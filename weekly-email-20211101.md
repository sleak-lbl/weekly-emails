...
- [(NEW) New Default Python module at AY transition (Wed Jan 19, 2022)](#python)
...
- [(NEW) Nominations for James Corones Award in Leadership, Community Building & Communication Now Open!](#corones)

## [Upcoming Training Events ](#section6) ##

- [(NEW) Training on Using Perlmutter, December 8-10](#usepm)
...
### (NEW) New Default Python module at AY transition (Wed Jan 19, 2022) <a name="python"/></a> 
...
### (NEW) Nominations for James Corones Award in Leadership, Community Building & Communication Now Open! <a name="corones"/></a> 
...
### (NEW) Training on Using Perlmutter, December 8-10 <a name="usepm"/></a> 
