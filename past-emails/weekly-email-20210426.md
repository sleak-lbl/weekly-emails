...
- [Nominations for ACM SIGHPC Graduate Fellowships in Computational and Data Science Close on Friday!](#sighpc)
- [First Allocation Reductions Begin Next Week](#allocred)

## [Updates at NERSC ](#section3) ##

- [(NEW) Codecov Users Must Expire/Reset Tokens or Keys Used by Codecov](#codecov)
- [(NEW) New Format for Ticket-Generated Emails](#snemail)
...
### Nominations for ACM SIGHPC Graduate Fellowships in Computational and Data Science Close on Friday! <a name="sighpc"/></a> 
...
### First Allocation Reductions Begin Next Week <a name="allocred"/></a> 
...
### (NEW) Codecov Users Must Expire/Reset Tokens or Keys Used by Codecov <a name="codecov"/></a> 
...
### (NEW) New Format for Ticket-Generated Emails <a name="snemail"/></a> 
